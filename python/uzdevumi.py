...
def desmitais(saraksts1,saraksts2):
    ...
    for elements in saraksts2:
        if elements % 2 == 1:
            jaunais_saraksts.append(elements)
    print("jaunais saraksts:", saraksts1)
    print ("otrais sarkasts:", saraksts2)
    print("apvienotasis saraksts:", jaunais_saraksts)
    return
...
def pedejais_ar_rekursiju(n):
    ...
    if n == 1:
        ...
        print("*", end = " ")
        pedejais_ar_rekursiju(n-1, j)

pedejais_ar_rekursiju(5, 5)